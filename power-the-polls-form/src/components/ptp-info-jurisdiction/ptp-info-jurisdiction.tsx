...
export class JurisdictionInfoComponent {
   ...
   private specialInfoMap: Record<string, string> = {
      ...
      "6240":
         "Please come into the elections office in person to apply at: 305 S Hightower St # 130, Thomaston, GA 30286", // Upson County, GA
      "6203": "Please call (706) 638-4349 to apply!", // Walker County, GA
      "6263":
         "Please apply online at: https://www.votewalton.gov/-No-Menu/Election-Worker-Application", // Walton County, GA
      "6242": "Please call (229) 828-5775 to apply!", // Webster County, GA
      "6279": "Please call (912) 568-0095 to apply!", // Wheeler County, GA
      "6162":
         "Please call (706) 865-7812 or email elections@whitecounty.net to apply!", // White County, GA
      ...
      "9047":
         "Please apply online at: https://www.mercercounty.org/boards-commissions/board-of-elections/board-worker-application", // Mercer County, NJ
      ...
      "6047":
         "Please call (860) 465-3016 or email registrars@windhamct.com to apply!", // Windham, CT
      "6067":
         "If you apply, please include in the 'notes' section that Power the Polls sent you :)", // Clay County, FL
      ...
      "6106":
         "Your county is fully staffed for 2024! Remember to thank your elections workers when you vote!", // Osceola County, FL
      ...
      "5810":
         "Consider 'adopting a precinct' online at: https://www.solanocounty.com/depts/rov/workers/adopt_a_poll.asp", // Solano County, CA
      "6035": "Please call 203) 574-6751 to apply!", // Waterbury, CT
      "9060":
         "Please apply online at: https://www.warrencountyvotes.com/home/showpublisheddocument/7523/638295895080430000", // Warren County, NJ
      "9517":
         "Please apply online at: https://airtable.com/applaVr8VXLc8miLW/shrT58SwXF1dEEhJh", // Delaware County, PA
      "9510":
         "Call (724) 852-5230 or email elections@co.greene.pa.us to apply!", // Greene County, PA
      "9519":
         "Call (814) 643-3091 ext. 205 or email ariley@huntingdoncounty.net to apply!", // Huntingdon County, PA
      ...
      "6132":
         "Please come to the elections office in person to apply at 337 Main St, Suite 101, Thomson, GA 30824!", // McDuffie County, GA
      "6198": "Please call (770) 749-2103 to apply!", // Polk County, GA
      "6251":
         "Apply online at: https://www.rockdalecountyga.gov/be-a-poll-worker/", // Rockdale County, GA
      ...
      "6282":
         "Please apply online at: https://charltoncountyga.us/DocumentCenter/View/438/Charlton-County-Employment-Application", // Charlton County, GA
      "6215":
         "Call (478) 374-3775 or email dodge.probatecourt@gmail.com to apply!", // Dodge County, GA
      "9537": "Please call (814) 755-3537 ext. 1 to apply!", // Forest County, PA
      "9910":
         "Email freda.ragan@taylorcounty.texas.gov and dan.murray@taylorcounty.texas.gov to apply!", // Taylor County, TX
      "6178":
         "Please come to the office at 201 North Davis St, Room 142, Nashville, GA 31639 to apply!", // Berrien County, GA
      "6209": "Please call (229) 768-2445 to apply!", // Clay County, GA
      "6218":
         "Please come in person to the elections office at 201 Freeman St, Suite 9, Claxton, GA 30417 to apply!", // Evans County, GA
      "10495":
      ...
      "6028":
         "Please call the Trumbull Registrars’ Office at: 203-452-5058 or 203-452-5059 to apply!", // Trumbull, CT
      ...
      if (j.vote_by_mail_jurisdiction) {
         return (
            <Fragment>
               ...
               <p>
                  {j.name} conducts elections by mail, meaning that the need for
                  poll workers is generally lower than many other states.
                  However, there still may be ways that you can support election
                  administrators in your area. We encourage you to contact your
                  county election office directly to find out about any
                  opportunities to get involved.
               </p>
               <p>
                  You can still help power the polls by voting in this upcoming
                  election, and encouraging your friends and family who live in
                  other states to sign up to be poll workers.
               </p>
            </Fragment>
         );
      }
      if (j.jurisdiction_is_fully_recruited) {
         return (
            <Host>
               ...
               <p>
                  <strong>You can still help power the polls</strong> by voting
                  in this upcoming election, and encouraging your friends and
                  family across the country to register to vote!
               </p>
               {!allNullOrEmpty(j?.telephone, j?.email, j?.office_address) ? (
                  <section>
                     <p>
                        If you are a current poll worker, or need to reach out
                        to the office for an update on your application or for
                        more information about your placement, please see below
         ...
         <Host>
            ...
            {this.specialInfo && (
               <div class="special-info">
                  <h2>
                     Special Instructions from Your Local Elections Office:
                  </h2>
              ...
              this.additionalInfoFormStatus === "pending" ? (
               ...
               <Fragment>
                  ...
                  <p>
                     ...
                     with your local elections office so that you can complete
                     the official poll worker application process with them.
                  </p>

                  <CompleteApplicationButton jurisdiction={j} />
                  <p>
                     This link will open a new tab connecting you to your local
                     elections office's poll worker application.
                  </p>

                  {
                     ...
                     !hasApplication ? (
                        ...
                        stateInfo.usePhoneInsteadOfEmailForFormFallback ? (
                           <Fragment>
                              <p>
                                 Unfortunately, there is not an online
                                 application for {stateInfo.name}. Call your
                                 local election administrator directly to
                                 express your interest in being a poll worker.
                              </p>
                              <p>
                                      ...
                                      () => (
                                         <Fragment>
                                            <strong>
                                               ...
                                               above! Election Day is right
                                               around the corner, so don’t waste
                                               any time getting your application
                                               in.
                                            </strong>{" "}
                                            Learn more about hours,
                                            compensation, and requirements for
                                 ...
                                 : [
                                      () => (
                                         <Fragment>
                                            ...
                                            Learn more about hours,
                                            compensation, and requirements for
                                            your community below and be sure to
                     ...
                     {!allNullOrEmpty(
                        ...
                        <ul>
                           ...
                           {j.full_day_required === "N" && (
                              <li class="other-details">
                                 <strong>Other Details</strong>
                                 <br></br>Part-day poll worker shifts are
                                 available.
                              </li>
                           )}
                        ...
                        <ul>
                           ...
                           {j.training_required && (
                              <li class="training">
                                 ...
                                 <br></br>Yes. You must attend a training
                                 session.
                              </li>
                           )}
                           {j.training_note && (
