   ...
   public render() {
      return (
         <Host>
            ...
            <div class="card">
               <a href="/press-release-2022-03-20" rel="noopener noreferrer">
                  <h3>
            ...
            <div class="card">
               <a href="/press-release-2020-09-25" rel="noopener noreferrer">
                  <h3>
                     Power the Polls Signs Up More Than 500,000 People Who Want
            ...
            <div class="card">
               <a href="/press-release-2020-06-30" rel="noopener noreferrer">
                  <h3>
