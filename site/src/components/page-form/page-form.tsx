            ...
            {!this.formComplete ? (
               <Fragment>
                  ...
                  <p>
                     ...
                     every election runs smoothly and everyone's vote is counted
                     — people like you.
                  </p>
                  <p>
                     When you sign up with Power the Polls, we’ll share
                     everything you need to apply to be a poll worker in your
                     community.
                  </p>
                  <p>
                     You can make sure we have safe, fair, efficient elections
                     for all voters. Step up and become a poll worker for the
                     next election today!
                  </p>
