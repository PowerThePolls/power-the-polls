            ...
            {!this.formComplete ? (
               <Fragment>
                  ...
                  <p>
                     ...
                     due to the coronavirus, and over 700,000 people stepped up
                     via Power the Polls to help meet that challenge. That was
                     just the beginning.
                  </p>
                  <p>
                     Our democracy depends on ordinary people who make sure
                     every election runs smoothly and everyone's vote is
                     counted. You can make sure we have safe, fair, and
                     efficient elections for all. Step up and become a poll
                     worker in your community this year.
                  </p>
