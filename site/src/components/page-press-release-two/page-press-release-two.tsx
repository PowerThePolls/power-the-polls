...
@Component({
    tag: "page-press-release-two",
    styleUrl: "page-press-release-two.scss",
    shadow: false,
})
export class PagePressReleaseTwo {
 ...
 Power the Polls recruits and supports poll workers by:
<ul><li>Educating potential voters on the opportunity and experience of manning Election Day polls.</li>
<li>Preparing potential poll workers for the experience of staffing polling places on Election Day.</li>
<li>Working with election administrators to identify specific areas of need for poll workers.</li>
<li>Establishing an efficient and effective program to ensure poll workers sign up and show up on Election Day.</li>
<li>Activating businesses to offer their employees flexibility on Election Day or the day off so they can work the polls.</li></ul>
                </p>
                <p>
