          ...
          <main role="main" aria-label="Advisory Council Page Main Content">
            <section aria-label="Council Description">
              <p class="council-description">
                ...
                political spectrum, united in their support for recruiting poll
                workers — one of the most effective, nonpartisan actions
                everyday Americans can take in support of our democracy.
              </p>
            </section>
              ...
              <div class="council-container">
                ...
                <div class="council-content">
                  <stencil-route-link url="/council-member/Crystal Echo Hawk">
                    ...
                    <p class="council-title">
                      Founder and Chief Executive Officer, IllumiNative
                    </p>
                  </stencil-route-link>
                </div>
              </div>
              ...
              <div class="council-container">
                ...
                <div class="council-content">
                  <stencil-route-link url="/council-member/Desmond Meade">
                    ...
                    <p class="council-title">
                      President and Executive Director, Florida Rights
              ...
              <div class="council-container">
                ...
                <div class="council-content">
                  <stencil-route-link url="/council-member/Gabriel Sterling">
                    ...
                    <p class="council-title">
                      Chief Operating Officer, Office of Georgia Secretary of
                      State
                    </p>
                  </stencil-route-link>
                </div>
