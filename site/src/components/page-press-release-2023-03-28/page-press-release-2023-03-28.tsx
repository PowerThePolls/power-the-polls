    ...
    public render() {
        return (
            <Host><a href="/press-and-media"><button>BACK TO PRESS AND MEDIA</button></a>
                <h1>New Survey Finds People Excited to Serve as Poll Workers in Future Elections</h1>
                <p><i>Ahead of 2022 midterm elections, Power the Polls recruited more than 275,000 potential poll workers to ensure a safe and fair election </i></p>
                <p>
...
<li>61% served as poll workers during the 2022 general election, with 95% reporting satisfaction in their work
</li></ul>
                </p>
                <p>
